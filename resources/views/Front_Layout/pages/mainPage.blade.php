  ...
  <section class="container pt-5 my-5 pb-lg-4">
    <div class="row pt-0 pt-md-2 pt-lg-0">
      ...
      <div class="col-xl-5 col-lg-6 col-md-7 order-md-1 pt-xl-5 pe-lg-0 mb-3 text-md-start text-center">
        ...
        <p class="position-relative lead me-lg-n5">We provide a complete service for the sale, purchase or rental of real estate. We have been operating more than 10 years. Search millions of apartments and houses on IPM.</p>
      </div>
            ...
            <div class="col-md-8 d-sm-flex align-items-center">
              ...
              <div class="dropdown w-sm-50 border-end-sm" data-bs-toggle="select">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="#"><span class="dropdown-item-label">duhok</span></a></li>
                  <li><a class="dropdown-item" href="#"><span class="dropdown-item-label">Erbil</span></a></li>
                  <li><a class="dropdown-item" href="#"><span class="dropdown-item-label">sulaymaniyah</span></a></li>
                </ul>
              </div>
              <hr class="d-sm-none my-2">
      ...
      <div class="tns-carousel-inner row gx-4 mx-0 py-md-4 py-3" data-carousel-options="{&quot;items&quot;: 4, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;500&quot;:{&quot;items&quot;:2},&quot;768&quot;:{&quot;items&quot;:3},&quot;992&quot;:{&quot;items&quot;:4}}}">
        ...
        <div class="col"><a class="card shadow-sm card-hover border-0" href="real-estate-catalog-sale.html">
            ...
            <div class="card-body text-center">
              <h3 class="mb-0 fs-base text-nav">chamchamal</h3>
            </div></a></div>
        <!-- Item-->
        <div class="col"><a class="card shadow-sm card-hover border-0" href="real-estate-catalog-rent.html">
            ...
            <div class="card-body text-center">
              <h3 class="mb-0 fs-base text-nav">sulaymaniyah</h3>
            </div></a></div>
        <!-- Item-->
        <div class="col"><a class="card shadow-sm card-hover border-0" href="real-estate-catalog-sale.html">
            ...
            <div class="card-body text-center">
              <h3 class="mb-0 fs-base text-nav">Duhok</h3>
            </div></a></div>
        <!-- Item-->
        <div class="col"><a class="card shadow-sm card-hover border-0" href="real-estate-catalog-rent.html">
            ...
            <div class="card-body text-center">
              <h3 class="mb-0 fs-base text-nav">Erbil</h3>
            </div></a></div>
        <!-- Item-->
        <div class="col"><a class="card shadow-sm card-hover border-0" href="real-estate-catalog-sale.html">
            ...
            <div class="card-body text-center">
              <h3 class="mb-0 fs-base text-nav">koysinjaq</h3>
            </div></a></div>
      </div>
    </div>
  </section>
