        ...
        <div class="offcanvas-lg offcanvas-start" id="filters-sidebar">
          ...
          <div class="offcanvas-header d-block border-bottom pt-0 pt-lg-4 px-lg-0">
            <ul class="nav nav-tabs mb-0">
                <li class="nav-item"><a class="nav-link" href="{{route('real_estate_catalog_rent')}}"><i class="fi-rent fs-base me-2"></i>For rent</a></li>
                <li class="nav-item"><a class="nav-link active" href="{{route('real_estate_catalog_sale')}}"><i class="fi-home fs-base me-2"></i>For sale</a></li>
            </ul>
          </div>
